...
export const MONTHLY_METRICS = [
  ...
  { group: 'pipeline', items: [
    { key: 'dms_sent', label: 'DMs Sent', autoFill: 'activity_log' },
    { key: 'offer_docs_sent', label: 'Offer Docs Sent', autoFill: 'activity_log' },
    { key: 'calls_booked', label: 'Calls Booked', autoFill: 'activity_log' },
    { key: 'calls_shown', label: 'Calls Shown', autoFill: 'daily_kpis', dkpiKey: 'calls_taken' },
    { key: 'calls_closed', label: 'Calls Closed', autoFill: 'activity_log' },
  ...
  { group: 'retention', items: [
    ...
    { key: 'new_members', label: 'New Members', autoFill: 'activity_log' },
    { key: 'members_resigned', label: 'Re-signed Members' },
  ]},
  { group: 'financials', items: [
    { key: 'revenue', label: 'Revenue (£)', step: '0.01' },
    { key: 'revenue_target', label: 'Target for Next Month (£)', step: '0.01' },
    { key: 'cash_collected', label: 'New Cash Collected (£)', autoFill: 'activity_log', step: '0.01' },
    { key: 'cash_contracted', label: 'New Cash Contracted (£)', autoFill: 'activity_log', step: '0.01' },
    { key: 'monthly_recurring_revenue', label: 'Monthly Recurring Revenue (£)', step: '0.01' },
