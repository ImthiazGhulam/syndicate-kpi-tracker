...
export const MONTHLY_METRICS = [
  { group: 'audience', items: [
    { key: 'new_followers', label: 'New Followers', autoFill: 'daily_kpis', dkpiKey: 'new_followers' },
  ...
  { group: 'pipeline', items: [
    ...
    { key: 'offer_docs_sent', label: 'Offer Docs Sent' },
    { key: 'calls_booked', label: 'Calls Booked', autoFill: 'daily_kpis', dkpiKey: 'calls_booked' },
  ...
  { group: 'financials', items: [
    { key: 'cash_collected', label: 'Cash Collected (£)', autoFill: 'daily_kpis', dkpiKey: 'cash_collected', step: '0.01' },
    { key: 'cash_contracted', label: 'Cash Contracted (£)', step: '0.01' },
